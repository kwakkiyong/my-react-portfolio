    ...
    <Section id="Interview" className="bg-transparent">
      <div className="w-full max-w-5xl mx-auto space-y-6 sm:space-y-10">
        ...
        <div className="space-y-4 sm:space-y-6 md:space-y-10">
          <Card className="bg-transparent border-blue-400 border-2 rounded-[2rem]">
            <CardHeader>
            ...
            <CardContent>
              <div>
                <p>
                  ...
                  이해했습니다. <br />
                  이후 AI 에이전트 빌더 프로젝트에서 React와 TypeScript 기반의 UI를 개발하면서, 프론트엔드 기술이 사용자
                  경험에 <br />
                  직접적인 영향을 준다는 점에 매력을 느꼈습니다.
